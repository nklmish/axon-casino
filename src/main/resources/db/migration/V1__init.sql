...
CREATE TABLE `samples_holder` (
  `id` varchar(255) NOT NULL,
  `json` longtext,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `top_wallet_summary_holder` (
  `id` varchar(255) NOT NULL,
  `json` longtext,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `total_deposited` (
...
CREATE TABLE `wallet_summary` (
  ...
  `available` decimal(19,2) DEFAULT NULL,
  `betted` decimal(19,2) DEFAULT NULL,
  `currency` varchar(255) DEFAULT NULL,
  `withdrawing` decimal(19,2) DEFAULT NULL,
  PRIMARY KEY (`wallet_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*
 * Quartz part of the schema, for clustered scheduling.
 */
